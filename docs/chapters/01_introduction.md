📝[Edit on github](https://github.com/boostercloud/booster/blob/main/docs/chapters/introduction.md)
...
- **Effective Multicloud**: Booster design makes it possible to run the same application in AWS, Azure or Kubernetes clusters with no code changes in your application.
