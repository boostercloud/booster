...
If you want to have the control over the infrastructure deployed to any cloud provider or have a full custom cloud implementation. Booster provides the possibility to develop a fully custom clod provider. 
