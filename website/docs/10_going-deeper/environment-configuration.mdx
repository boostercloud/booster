...
For managing dynamic configuration values that can be updated without redeployment, Booster provides a comprehensive configuration management system with support for external configuration providers like Azure App Configuration.

See the [Configuration Management](/features/configuration) documentation for detailed information about:
- Multi-tier configuration resolutions
