...
Before starting, make sure to [have Booster CLI installed](installation). If you also want to deploy your application to your cloud provider, check out the [Provider configuration](configuration) section.
