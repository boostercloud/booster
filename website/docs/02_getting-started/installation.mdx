...
the stable versions are published to <CustomLink href="https://www.npmjs.com/package/@boostercloud/cli" onClick={() => fathom.trackGoal('AXTW7ICE', 0)}> `npm`,</CustomLink>
...
something like
<CustomLink href="https://www.npmjs.com/package/@boostercloud/cli" onClick={() => fathom.trackGoal('AXTW7ICE', 0)}> `npm`</CustomLink
