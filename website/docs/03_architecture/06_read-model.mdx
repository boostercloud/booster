...
## Projecting fields from a Read Model

See the [`Read Models data at code level`](/graphql#getting-filtering-and-projecting-read-models-data-at-code-level) section for more information about how to project fields from a Read Model.
