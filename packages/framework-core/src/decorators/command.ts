...
import { CommandClassInterface, RoleAccess } from '@boostercloud/framework-types'
 ...
 * @constructor
 */
export function Command(attributes: RoleAccess): <TCommand>(commandClass: CommandClassInterface<TCommand>) => void {
  return (commandClass) => {
