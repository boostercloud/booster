import { Class, FilterHooks, ReadModelInterface, RoleAccess } from '@boostercloud/framework-types'
 ...
 * @param attributes
 */
export function ReadModel(attributes: RoleAccess & FilterHooks): (readModelClass: Class<ReadModelInterface>) => void {
