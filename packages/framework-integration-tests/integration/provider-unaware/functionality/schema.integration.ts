...
describe('schemas', async () => {
  ...
  it('should return the expected schema for filter fields', async () => {
    ...
    expectInputField(inputFields[14], 'optionalString', 'StringPropertyFilter')
    expectInputField(inputFields[15], 'optionalNull', 'StringPropertyFilter')
    expectInputField(inputFields[16], 'optionalUndefined', 'JSONObject', 'SCALAR')
    expectInputField(inputFields[17], 'optionalUnknown', 'JSONObject', 'SCALAR')
    expectInputField(inputFields[18], 'optionalAny', 'JSONObject', 'SCALAR')
    expectInputField(inputFields[19], 'optionalRecord', 'JSONObject', 'SCALAR')
    expectInputField(inputFields[20], 'readonlyArray', 'JSONObject', 'SCALAR')
  })
  ...
  it('should return the expected schema for sort fields', async () => {
    ...
    expectInputField(inputFields[14], 'optionalString', 'orderProperty', 'ENUM')
    expectInputField(inputFields[15], 'optionalNull', 'orderProperty', 'ENUM')
    expectInputField(inputFields[16], 'optionalUndefined', 'orderProperty', 'ENUM')
    expectInputField(inputFields[17], 'optionalUnknown', 'orderProperty', 'ENUM')
    expectInputField(inputFields[18], 'optionalAny', 'orderProperty', 'ENUM')
    expectInputField(inputFields[19], 'optionalRecord', 'orderProperty', 'ENUM')
    expectInputField(inputFields[20], 'readonlyArray', 'orderProperty', 'ENUM')
  })
  ...
  it('should return the expected schema for search items', async () => {
    ...
    expectInputField(fields[14], 'optionalString', 'String', 'SCALAR', '__Type', '__Field')
    expectInputField(fields[15], 'optionalNull', 'String', 'SCALAR', '__Type', '__Field')
    expectInputField(fields[16], 'optionalUndefined', 'JSONObject', 'SCALAR', '__Type', '__Field')
    expectInputField(fields[17], 'optionalUnknown', 'JSONObject', 'SCALAR', '__Type', '__Field')
    expectInputField(fields[18], 'optionalAny', 'JSONObject', 'SCALAR', '__Type', '__Field')
    expectInputField(fields[19], 'optionalRecord', 'JSONObject', 'SCALAR', '__Type', '__Field')

    expect(fields[20].__typename).to.be.eq('__Field')
    expect(fields[20].name).to.be.eq('readonlyArray')
    expect(fields[20].type.__typename).to.be.eq('__Type')
    expect(fields[20].type.name).to.be.null
    expect(fields[20].type.kind).to.be.eq('LIST')
    expect(fields[20].type.ofType.__typename).to.be.eq('__Type')
    expect(fields[20].type.ofType.name).to.be.eq('String')
    expect(fields[20].type.ofType.kind).to.be.eq('SCALAR')
  })
})
