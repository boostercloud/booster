...
import { AzurermProvider, AzurermProviderFeatures } from '@cdktn/provider-azurerm/lib/provider'
...
import { storageAccount, windowsFunctionApp } from '@cdktn/provider-azurerm'
