...
describe('generate service', (): void => {
  ...
  describe('generates file from default template', () => {
    it('command', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/commands/new-command.ts'), rendered)
    ...
    it('entity', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/entities/new-entity.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
    ...
    it('event handler', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/event-handlers/new-event-handler.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
    ...
    it('event', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/events/new-event.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
    ...
    it('read model', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/read-models/new-read-model.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
    ...
    it('scheduled command', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/scheduled-commands/new-scheduled-command.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
    ...
    it('type', async () => {
      ...
      expect(fs.outputFile).to.have.been.calledWithMatch(path.normalize('src/common/new-type.ts'), rendered)
      expect(projectChecker.checkResourceExists).to.have.been.called
