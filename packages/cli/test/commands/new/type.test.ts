    ...
    describe('Type', () => {
        ...
        describe('Created correctly', () => { 
            ...
            it('creates Type with multiple fields', async () => {
                await new Type([typeName, '--fields', 'title:string','quantity:number','identifier:UUID'], {} as IConfig).run()
                const renderedType = Mustache.render(templates.type, {
                    imports: uuidTypeImports,
                    name: typeName,
        ...
        describe('displays an error', () => { 
            ...
            it('with empty Type name', async () => {
                ...
                expect(console.error).to.have.been.calledWith("You haven't provided a type name, but it is required, run with --help for usage")
            })
